...
class RevenueByLane implements FromCollection, WithTitle, WithColumnWidths, WithCustomStartCell, WithHeadings, WithStyles
{
    private $period;
    ...
    public function styles(Worksheet $sheet)
    {
        ...
        $sheet->getStyle('C6:D7')->applyFromArray($yellowFieldStyle);
        $sheet->getStyle('C6:D7')->getBorders()->getAllBorders()->setBorderStyle(Border::BORDER_DOTTED);        
        ...
        $sheet->getStyle('B8:D8')->applyFromArray($subTotalCellStyle);
