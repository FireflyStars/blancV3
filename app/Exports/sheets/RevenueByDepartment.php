...
class RevenueByDepartment implements FromCollection, WithTitle, WithColumnWidths, WithCustomStartCell, WithHeadings, WithStyles
{
    ...
    public function styles(Worksheet $sheet)
    {
        ...
        $sheet->getStyle('C6:D11')->applyFromArray($yellowFieldStyle);
        $sheet->getStyle('C6:D11')->getBorders()->getAllBorders()->setBorderStyle(Border::BORDER_DOTTED);        

        $sheet->getStyle('C13:D16')->applyFromArray($yellowFieldStyle);
        $sheet->getStyle('C13:D16')->getBorders()->getAllBorders()->setBorderStyle(Border::BORDER_DOTTED);        
        $subTotalCellStyle = [
            'font'  =>[
                'bold'  => true,
                'color' => ['argb' => Color::COLOR_BLACK],
        ...
        $sheet->getStyle('B17:D17')->applyFromArray($subTotalCellStyle);
        $sheet->getStyle('B17:D17')->getBorders()->getBottom()->setBorderStyle(Border::BORDER_MEDIUM);
