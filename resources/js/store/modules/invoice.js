...
export const invoicelist= {
    ...
    mutations: {
        ...
        [SET_INVOICE_FILTER]: (state, payload) => { 
            ...
            state.filter.first_name = payload.first_name.value;            
            state.filter.last_name = payload.last_name.value;            
            state.filter.order_id = payload.order_id.value;            
            state.filter.sub_order = payload.sub_order.value;            
            state.filter.item = payload.item.value;            
