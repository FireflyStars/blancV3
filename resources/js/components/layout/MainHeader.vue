<template>
    <div class="row main-logo">
        <div class="col-12 p-0">
            ...
            <svg width="37" height="37" style="margin:14px 0  0 16px" viewBox="0 0 37 37" fill="none" xmlns="http://www.w3.org/2000/svg" @click="slideinMenu">
        ...
        <button class="btn btn-white body_medium" @click="featureunavailable('New order')">New Order</button>
        </div>
    </div>
</template>
